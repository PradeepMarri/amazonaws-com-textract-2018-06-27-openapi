...
func DetectdocumenttextHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DetectDocumentTextRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Textract.DetectDocumentText", cfg.BaseURL)
		...
		var result models.DetectDocumentTextResponse
...
func CreateDetectdocumenttextTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    DetectdocumenttextHandler(cfg),
	}
}
