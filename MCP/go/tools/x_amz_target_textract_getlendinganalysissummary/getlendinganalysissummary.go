...
func GetlendinganalysissummaryHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetLendingAnalysisSummaryRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Textract.GetLendingAnalysisSummary", cfg.BaseURL)
		...
		var result models.GetLendingAnalysisSummaryResponse
...
func CreateGetlendinganalysissummaryTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetlendinganalysissummaryHandler(cfg),
	}
}
