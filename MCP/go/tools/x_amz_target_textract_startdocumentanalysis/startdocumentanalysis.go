...
func StartdocumentanalysisHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.StartDocumentAnalysisRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Textract.StartDocumentAnalysis", cfg.BaseURL)
		...
		var result models.StartDocumentAnalysisResponse
...
func CreateStartdocumentanalysisTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    StartdocumentanalysisHandler(cfg),
	}
}
